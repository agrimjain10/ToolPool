    ...
    <main className="landing-page">
      <section className="intro-band landing-band">
        <div className="intro-copy">
          <p className="eyebrow">College sharing hub</p>
          <h1>Borrow what you need. Share what you own.</h1>
          <p>
            CampusShare is a real MERN app backed by MongoDB, Express, React, and Node.
            Sign in to list items, send requests, and manage everything in one place.
          </p>
      ...
      <section className="browse-section landing-section">
        <div className="landing-grid">
          ...
          <article className="feature-card">
            ...
            <p>Add items from the UI and store them in the database, not in a temporary demo list.</p>
          </article>
          <article className="feature-card">
